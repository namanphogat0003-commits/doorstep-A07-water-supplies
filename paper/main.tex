...
\begin{figure}[t]
\centering
\includegraphics[width=\columnwidth]{02_slot_type_vs_addon.png}
...
\begin{figure}[t]
\centering
\includegraphics[width=\columnwidth]{03_functional_form.png}
...
Table~\ref{tab:accuracy} reports the comparison. The three families are indistinguishable, and the ten-seed spread is what makes that statement
...
\begin{figure}[t]
\centering
\includegraphics[width=\columnwidth]{07_tank_feasibility.png}
...
day across 8,342 crew-days, with a 95th percentile of 544~L---beyond every tank in the fleet.
